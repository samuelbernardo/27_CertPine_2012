...
'''
SSL connection extablishment and certificate validation using OpenSSL,
not sure why this is not working, not sure if certificate is being badly evaluated or if problems with
cacerts.pem
'''
